...
echo krb5-config krb5-config/add_servers_realm string krb5.$domain | debconf-set-selections
...
echo krb5-config krb5-config/kerberos_servers string krb5.$domain | debconf-set-selections
